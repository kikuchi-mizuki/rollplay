...
- クロージング力: 次のアクション・決定を促す適切なクロージング"""
        ...
        {{
            ...
            "strengths": [
                "【ヒアリング力】ディレクターは「〇〇という課題があるんですね」と相手の発言を丁寧に確認していました。この姿勢により、クライアントは安心して本音を話すことができ、信頼関係の構築に繋がっています。60-120文字で詳しく記載すること。",
                "【企画提案力】「△△のような動画を制作することで、××という効果が期待できます」と具体的な提案をしていました。クライアントの課題に対する解決策が明確で、説得力のある提案でした。60-120文字で詳しく記載すること。",
                "【コミュニケーション力】クライアントの発言に対して適切な相槌を打ち、会話のテンポを保っていました。この姿勢により、スムーズなコミュニケーションが実現できていました。60-120文字で詳しく記載すること。",
                "【プロジェクト管理力】「納期は〇〇日を予定しています」と具体的なスケジュールを提示していました。クライアントが計画を立てやすくなる重要な情報提供でした。60-120文字で詳しく記載すること。",
                "【全体の流れ】挨拶から要件ヒアリング、提案までの流れがスムーズで、クライアントを適切に導いていました。会話全体の構成が良く、次のステップに進みやすい状態を作れていました。60-120文字で詳しく記載すること。"
            ],
            "improvements": [
                "【ヒアリング力】クライアントの目的は聞けていましたが、「具体的にどのような層をターゲットにしたいですか？」のように、より深掘りした質問があるとさらに良いでしょう。ターゲット層の明確化により、より的確な提案が可能になります。60-120文字で詳しく記載すること。",
                "【企画提案力】提案自体は良かったのですが、「過去に類似案件で〇〇という成果がありました」のように、具体的な事例や数値を示すとさらに説得力が増します。クライアントの不安を解消し、決断を後押しできます。60-120文字で詳しく記載すること。",
                "【プロジェクト管理力】納期や予算についての確認が不足していました。「ご予算はどのくらいをお考えですか？」と早めに確認することで、実現可能な提案ができ、後のトラブルを防げます。60-120文字で詳しく記載すること。",
                "【コミュニケーション力】クライアントの発言を要約して確認する場面が少なかったです。「つまり〇〇ということですね」と要約することで、認識のズレを防ぎ、より深い信頼関係を築けます。60-120文字で詳しく記載すること。",
                "【クロージング】次のアクションが曖昧でした。「次回、具体的な企画書をお持ちします。〇月〇日はいかがでしょうか？」のように、具体的な日時を提案することで、商談を前進させられます。60-120文字で詳しく記載すること。"
            ],
            "overall": "総合評価（全体の印象、優れていた点の総括、改善すべき点の総括、次回への具体的なアドバイス。150-300文字程度で詳しく記載）",
            "detailedFeedback": {{
                "hearing": {{
                    "rationale": "ヒアリング力のスコアをこの点数にした理由を詳しく説明してください（必ず「5点満点中X点」という表現を含める）。良かった点と改善点の両方を含め、なぜこのスキルが制作要件の把握において重要なのか、クライアントの情報開示への影響を具体的に分析してください。120-200文字程度で詳しく記載すること。",
                    "examples": ["ディレクターが実際に言った具体的な質問やヒアリング発言（実質的な内容を含むもの、フィラーのみは不可）", "別の具体的なヒアリング発言"],
                    "improvement_suggestion": "ヒアリング力をさらに向上させるための具体的なアドバイス。次回のロープレで試すべきヒアリングテクニックや、より深くクライアントの要望を引き出す方法を70-120文字程度で詳しく記載すること。"
                }},
                "planning": {{
                    "rationale": "企画提案力のスコアをこの点数にした理由を詳しく説明してください（必ず「5点満点中X点」という表現を含める）。良かった点と改善点の両方を含め、なぜこのスキルが動画制作の成功において重要なのか、クライアントの期待値への影響を具体的に分析してください。120-200文字程度で詳しく記載すること。",
                    "examples": ["ディレクターが実際に言った具体的な企画提案の発言（実質的な内容を含むもの）", "別の具体的な提案発言"],
                    "improvement_suggestion": "企画提案力をさらに向上させるための具体的なアドバイス。より創造的で効果的な企画提案方法や、クライアントのビジネス課題に直結する提案の仕方を70-120文字程度で詳しく記載すること。"
                }},
                "communication": {{
                    "rationale": "コミュニケーション力のスコアをこの点数にした理由を詳しく説明してください（必ず「5点満点中X点」という表現を含める）。良かった点と改善点の両方を含め、なぜこのスキルがクライアントとの信頼関係構築において重要なのか、プロジェクトの進行への影響を具体的に分析してください。120-200文字程度で詳しく記載すること。",
                    "examples": ["ディレクターが実際に言った具体的なコミュニケーション発言（実質的な内容を含むもの）", "別の具体的なコミュニケーション発言"],
                    "improvement_suggestion": "コミュニケーション力をさらに向上させるための具体的なアドバイス。より分かりやすい説明方法や、クライアントの不安を解消するコミュニケーション技術を70-120文字程度で詳しく記載すること。"
                }},
                "project_management": {{
                    "rationale": "プロジェクト管理力のスコアをこの点数にした理由を詳しく説明してください（必ず「5点満点中X点」という表現を含める）。良かった点と改善点の両方を含め、なぜこのスキルがプロジェクトの成功において重要なのか、納期・予算・品質への影響を具体的に分析してください。120-200文字程度で詳しく記載すること。",
                    "examples": ["ディレクターが実際に言った具体的なプロジェクト管理の発言（納期・予算・工程に関する実質的な内容）"],
                    "improvement_suggestion": "プロジェクト管理力をさらに向上させるための具体的なアドバイス。より効果的なスケジュール管理方法や、リスク回避のための工程確認テクニックを70-120文字程度で詳しく記載すること。"
                }}
            }},
            "actionPlan": [
        ...
        {{
            ...
            "strengths": [
                "【質問力】営業は「現在、どのような課題を感じていらっしゃいますか？」と顧客の課題を引き出す質問をしていました。この質問により、顧客のニーズを的確に把握でき、適切な提案に繋げることができています。60-120文字で詳しく記載すること。",
                "【傾聴力】「なるほど、〇〇という課題があるんですね」と顧客の発言を丁寧に受け止めていました。この姿勢により、顧客は安心して本音を話すことができ、信頼関係の構築に繋がっています。60-120文字で詳しく記載すること。",
                "【提案力】「月10本のショート動画制作で、△△という効果が期待できます」と具体的な提案をしていました。顧客の課題に対する解決策が明確で、説得力のある提案でした。60-120文字で詳しく記載すること。",
                "【クロージング力】「次回、具体的なプランをご提案させていただけますか？」と次のステップを明確に示していました。商談を前進させる重要なアクションです。60-120文字で詳しく記載すること。",
                "【全体の流れ】挨拶からヒアリング、提案、クロージングまでの流れがスムーズで、顧客を適切に導いていました。会話全体の構成が良く、次のステップに進みやすい状態を作れていました。60-120文字で詳しく記載すること。"
            ],
            "improvements": [
                "【質問力】顧客の課題は聞けていましたが、「具体的にどのような効果を期待していますか？」のように、より深掘りした質問があるとさらに良いでしょう。期待値の明確化により、より的確な提案が可能になります。60-120文字で詳しく記載すること。",
                "【傾聴力】顧客の発言を受け止めていましたが、「つまり〇〇ということですね」と要約して確認する場面があるとさらに良いです。認識のズレを防ぎ、より深い信頼関係を築けます。60-120文字で詳しく記載すること。",
                "【提案力】提案自体は良かったのですが、「過去に類似案件で〇〇という成果がありました」のように、具体的な事例や数値を示すとさらに説得力が増します。顧客の不安を解消し、決断を後押しできます。60-120文字で詳しく記載すること。",
                "【クロージング力】次のアクションは提示できていましたが、「〇月〇日の午後はいかがでしょうか？」のように、具体的な日時まで提案するとさらに良いです。商談のスピード感が増します。60-120文字で詳しく記載すること。",
                "【全体のバランス】ヒアリングと提案の時間配分を意識しましょう。顧客の話を十分に聞いてから提案することで、より的確な提案ができ、成約率が高まります。60-120文字で詳しく記載すること。"
            ],
            "overall": "総合評価（全体の印象、優れていた点の総括、改善すべき点の総括、次回への具体的なアドバイス。150-300文字程度で詳しく記載）",
            "detailedFeedback": {{
                "questioning": {{
                    "rationale": "質問力のスコアをこの点数にした理由を詳しく説明してください（必ず「5点満点中X点」という表現を含める）。良かった点と改善点の両方を含め、なぜこのスキルが営業において重要なのか、顧客にどのような影響を与えたかを具体的に分析してください。120-200文字程度で詳しく記載すること。",
                    "examples": ["営業が実際に言った具体的な質問（実質的な内容を含むもの、フィラーのみは不可。例：「現在の課題は何ですか？」）", "別の具体的な質問"],
                    "improvement_suggestion": "質問力をさらに向上させるための具体的なアドバイス。次回のロープレで試すべき質問テクニックや、より効果的な質問の仕方を70-120文字程度で詳しく記載すること。"
                }},
                "listening": {{
                    "rationale": "傾聴力のスコアをこの点数にした理由を詳しく説明してください（必ず「5点満点中X点」という表現を含める）。良かった点と改善点の両方を含め、なぜこのスキルが信頼関係構築において重要なのか、顧客の心理にどのような影響を与えたかを具体的に分析してください。120-200文字程度で詳しく記載すること。",
                    "examples": ["営業が実際に言った具体的な傾聴の発言（実質的な内容を含むもの。例：「なるほど、〇〇ということですね」）", "別の具体的な傾聴発言"],
                    "improvement_suggestion": "傾聴力をさらに向上させるための具体的なアドバイス。より効果的な相槌の打ち方や、顧客の発言を深掘りするテクニックを70-120文字程度で詳しく記載すること。"
                }},
                "proposing": {{
                    "rationale": "提案力のスコアをこの点数にした理由を詳しく説明してください（必ず「5点満点中X点」という表現を含める）。良かった点と改善点の両方を含め、なぜこのスキルが成約において重要なのか、提案の説得力や顧客の反応への影響を具体的に分析してください。120-200文字程度で詳しく記載すること。",
                    "examples": ["営業が実際に言った具体的な提案の発言（実質的な内容を含むもの。例：「月10本のショート動画制作をお手伝いできます」）", "別の具体的な提案発言"],
                    "improvement_suggestion": "提案力をさらに向上させるための具体的なアドバイス。より説得力のある提案方法や、顧客のニーズに合わせた提案のカスタマイズ方法を70-120文字程度で詳しく記載すること。"
                }},
                "closing": {{
                    "rationale": "クロージング力のスコアをこの点数にした理由を詳しく説明してください（必ず「5点満点中X点」という表現を含める）。良かった点と改善点の両方を含め、なぜこのスキルが商談の前進において重要なのか、顧客の意思決定への影響を具体的に分析してください。120-200文字程度で詳しく記載すること。",
                    "examples": ["営業が実際に言った具体的なクロージング発言（実質的な内容を含むもの。例：「次回、具体的なプランをご提案させていただけますか？」）"],
                    "improvement_suggestion": "クロージング力をさらに向上させるための具体的なアドバイス。より自然で効果的なクロージング方法や、顧客の心理的なハードルを下げるテクニックを70-120文字程度で詳しく記載すること。"
                }}
            }},
            "actionPlan": [
                "次回のロープレで実践すべき具体的なアクション1（40-70文字程度で詳しく）",
        ...
        【必須事項 - これらを厳守すること】
        - **strengths（良かった点）**: 【重要】必ず5項目以上（理想は5-6項目）を記載してください（空欄・3項目は絶対に不可）
          - 挨拶、言葉遣い、質問の仕方、声のトーン、会話の流れなど、多角的に評価
          - 【重要】各項目は必ず60-120文字で詳しく記載すること（短い1-2行の評価は不可）
          - 具体的な発言を「　」で引用し、「なぜ良いか」「どのような効果があるか」を詳しく明記
        - **improvements（改善点）**: 【重要】必ず5項目以上（理想は5-6項目）を記載（空欄・3項目は絶対に不可）
          - 【重要】各項目は必ず60-120文字で詳しく記載すること（短い1-2行の評価は不可）
          - 具体的な発言を「　」で引用し、「なぜ改善が必要か」「どう改善すべきか」「改善するとどんな効果があるか」を詳しく明記
        - **overall（総合評価）**: 【重要】150-300文字で詳しく記載（100文字以下は不可）
        ...
        【再確認】上記の例に従い、strengths・improvements共に必ず5項目以上、各60-120文字で詳細に記載してください。
        """
...
- 【最重要】strengths・improvementsは必ず5項目以上（理想は5-6項目）記載してください。3項目は絶対に不可です。
- 【最重要】各項目は60-120文字で詳しく記載してください。短い1-2行の評価は不可です。
- rationaleは80-120文字程度で、良かった点と改善点の両方に触れながら詳細に分析してください
- 具体的な発言を「　」で囲んで多く引用し、なぜその発言が良い/改善が必要かを詳しく説明してください

【必須】良かった点（strengths）を必ず5個以上見つけて記載してください。小さな良い点でも評価対象です。
【必須】改善点（improvements）も必ず5個以上記載してください。
【必須】上記のJSONの例を参考に、同じレベルの詳細度で記載してください。"""
        else:
            system_message = """【最重要指示】あなたの出力は必ず有効なJSON形式のみとしてください。説明文や前置きは一切不要です。
